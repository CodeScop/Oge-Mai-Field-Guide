...
- **Quests:** Swamp: Wading Through & Onwards 1/2 (1), Twisted Treacherous Trails 2/2 (5), No Safe Feet (10)
...
- **Quests:** none upon first appearance
...
### Knusha (to integrate Exp: SurfaceC)
...
### Vota (to integrate Exp: SurfaceC)
...
### Wyvern (to integrate Exp: SurfaceC)
...
### Yala (to integrate Exp: SurfaceC)
