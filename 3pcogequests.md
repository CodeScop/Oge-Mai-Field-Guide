## Three Points Crossing Main Quests
...
### * Written Accounts: Attack on 3 Points

- **Unlocked by:** Written Accounts
- **Type:** Words
...
NOTE: This quest isn't possible to complete until you reach Riza Rivertown. Given the intensity of its prerequisite, I would guess you're not expected to unlock it until then. I'll therefore completely ignore this for now in Resources, and come back to it when we get to Riza Rivertown.

- **Unlocked by:** Lighten the Load
- **Type:** Collection
...
## Mama Tree Sidequests Unlocked By 3PC
