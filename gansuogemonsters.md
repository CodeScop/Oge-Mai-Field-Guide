...
### * Bruja (Available ONLY during Main Quests 4-7)
...
### * Dust Witch (Available ONLY during Main Quest 8)

I'm going to reiterate what I said in the Quest advice: if you haven't turned in Main Quest 8 yet, don't do so until you've milked this to its last drop. In seriousness, consider resetting the game to the start of Gansu if you don't have any more progress than Gansu to lose. It's worth milking these Stempos and Stone Chests. All drops are considered products of Main Quest 8 on my Resources section.
...
### * Kiru (Available ONLY during Main Quests 4-7)
...
### * Lombri (Available ONLY during Main Quest 4)
...
### * Suulan (Unlocked by Main Quest 3: Sacred Shrine)
...
### * Yasri (Available ONLY during Main Quest 4)
